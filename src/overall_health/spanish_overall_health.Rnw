...
ggplot(data = dummy, aes(x = x, y = y)) +
    ...
    annotate("text", size = 7, label = "Mala", x = 28, y = 95) +
    annotate("text", size = 7, label = "Regular", x = 44, y = 95) +
    annotate("text", size = 7, label = "Buena", x = 59.5, y = 95) +
    annotate("text", size = 7, label = "Muy Buena", x = 75, y = 95) +
    annotate("text", size = 7, label = "Excelente", x = 92, y = 95) +
    ...
    annotate("text",
             label = sprintf("Usted\n%s",
                             get_overall_health_text(config_pt_overall, 'spanish')),
             x = 10,
             y = 75,
             size = 5) +
    annotate("text",
             label = sprintf("%s de la\nmisma edad que\nusted\n%s",
                             get_men_women(config_pt_sex, 'spanish'),
                             get_overall_health_text(config_sex_age_overall, 'spanish')),
             x = 10,
             y = 30,
             size = 5)
@
