...
ggplot(data = dummy, aes(x = x, y = y)) +
    ...
    annotate("text", label = "Systolic", x = 82, y = 82, size = 4) +
    annotate("text", label = "Diastolic", x = 81.5, y = 59.5, size = 4) +
