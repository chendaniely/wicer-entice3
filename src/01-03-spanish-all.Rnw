...
<<body_mass_index_text, child="body_mass_index/spanish_body_mass_index_text.Rnw">>=
@

<<waist_measurement_image, child="waist_measurement/spanish_waist_measurement_image.Rnw">>=
@

<<waist_measurement_text, child="waist_measurement/spanish_waist_measurement_text.Rnw">>=
@

<<days_feeling_depressed_image, child="days_feeling_depressed/spanish_days_feeling_depressed_image.Rnw">>=
@

<<days_feeling_depressed_text, child="days_feeling_depressed/spanish_days_feeling_depressed_text.Rnw">>=
@

<<days_feeling_anxious_image, child="days_feeling_anxious/spanish_days_feeling_anxious_image.Rnw">>=
@

<<days_feeling_anxious_text, child="days_feeling_anxious/spanish_days_feeling_anxious_text.Rnw">>=
@

<<fruit_servings_per_day_image, child="fruit_servings_per_day/spanish_fruit_servings_per_day_image.Rnw">>=
@

<<fruit_servings_per_day_text, child="fruit_servings_per_day/spanish_fruit_servings_per_day_text.Rnw">>=
@

<<vegetable_servings_per_day_image, child="vegetable_servings_per_day/spanish_vegetable_servings_per_day_image.Rnw">>=
@

<<vegetable_servings_per_day_text, child="vegetable_servings_per_day/spanish_vegetable_servings_per_day_text.Rnw">>=
@

<<minutes_vigorous_exercise_image, child="minutes_vigorous_exercise/spanish_minutes_vigorous_exercise_image.Rnw">>=
@

<<minutes_vigorous_exercise_text, child="minutes_vigorous_exercise/spanish_minutes_vigorous_exercise_text.Rnw">>=
@

<<minutes_moderate_exercise_image, child="minutes_moderate_exercise/spanish_minutes_moderate_exercise_image.Rnw">>=
@

<<minutes_moderate_exercise_text, child="minutes_moderate_exercise/spanish_minutes_moderate_exercise_text.Rnw">>=
@

<<composite_beverage_servings_image, child="composite_beverage_servings/spanish_composite_beverage_servings_image.Rnw">>=
@

<<composite_beverage_servings_text, child="composite_beverage_servings/spanish_composite_beverage_servings_text.Rnw">>=
@

<<composite_30_day_measures_image, child="composite_30_day_measures/spanish_composite_30_day_measures_image.Rnw">>=
@

<<composite_30_day_measures_text, child="composite_30_day_measures/spanish_composite_30_day_measures_text.Rnw">>=
@

<<recommended_physical_activity_image, child="recommended_physical_activity/spanish_recommended_physical_activity_image.Rnw">>=
@

<<recommended_physical_activity_text, child="recommended_physical_activity/spanish_recommended_physical_activity_text.Rnw">>=
@

<<beverage_recommendations_image, child="beverage_recommendations/spanish_beverage_recommendations_image.Rnw">>=
@

<<beverage_recommendations_text, child="beverage_recommendations/spanish_beverage_recommendations_text.Rnw">>=
@

<<depression_symptoms_a_image, child="depression_symptoms_a/spanish_depression_symptoms_a_image.Rnw">>=
@

<<depression_symptoms_a_text, child="depression_symptoms_a/spanish_depression_symptoms_a_text.Rnw">>=
@

<<prolonged_stress_image, child="prolonged_stress/spanish_prolonged_stress_image.Rnw">>=
@

<<prolonged_stress_text, child="prolonged_stress/spanish_prolonged_stress_text.Rnw">>=
@

<<anxiety_symptoms_image, child="anxiety_symptoms/spanish_anxiety_symptoms_image.Rnw">>=
@

<<anxiety_symptoms_text, child="anxiety_symptoms/spanish_anxiety_symptoms_text.Rnw">>=
@

<<depression_symptoms_b_image, child="depression_symptoms_b/spanish_depression_symptoms_b_image.Rnw">>=
@

<<depression_symptoms_b_text, child="depression_symptoms_b/spanish_depression_symptoms_b_text.Rnw">>=
@

<<overall_health_image, child="overall_health/spanish_overall_health_image.Rnw">>=
@

<<overall_health_text, child="overall_health/spanish_overall_health_text.Rnw">>=
@

<<loss_of_energy_image, child="loss_of_energy/spanish_loss_of_energy_image.Rnw">>=
@

<<loss_of_energy_text, child="loss_of_energy/spanish_loss_of_energy_text.Rnw">>=
@

<<risks_of_high_blood_pressure_image, child="risks_of_high_blood_pressure/spanish_risks_of_high_blood_pressure_image.Rnw">>=
@

<<risks_of_high_blood_pressure_text, child="risks_of_high_blood_pressure/spanish_risks_of_high_blood_pressure_text.Rnw">>=
@

<<risks_of_excess_weight_image, child="risks_of_excess_weight/spanish_risks_of_excess_weight_image.Rnw">>=
@

<<risks_of_excess_weight_text, child="risks_of_excess_weight/spanish_risks_of_excess_weight_text.Rnw">>=
@

<<health_summary_control_panel_image, child="health_summary_control_panel/spanish_health_summary_control_panel_image.Rnw">>=
@

<<health_summary_control_panel_text, child="health_summary_control_panel/spanish_health_summary_control_panel_text.Rnw">>=
@
...
<<health_comparted_to_ideal_cloverleaf_text, child="health_compared_to_ideal_cloverleaf/spanish_health_compared_to_ideal_cloverleaf_text.Rnw">>=
@
