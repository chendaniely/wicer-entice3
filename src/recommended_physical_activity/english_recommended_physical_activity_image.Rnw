...
<<results='hide'>>=
png(filename = 'src/recommended_physical_activity/moderate_exercise_plot.png', width = 800, height = 600, antialias = "subpixel")
...
\begin{figure}[H]
\includegraphics[scale=0.37, width=\linewidth]{moderate_exercise_plot}
\end{figure}
