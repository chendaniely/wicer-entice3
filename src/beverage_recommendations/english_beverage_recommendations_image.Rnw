...
\begin{center}
\Huge{\textbf{Your Servings per Week of Beverages Containing Sugar}}
\end{center}
\vspace{1cm}
\centering
...
\begin{minipage}[b]{0.45\linewidth}
\begin{center}
\Huge{\textbf{Beverage Recommendations}}
\end{center}
\vspace{2cm}
\centering
\includegraphics[width=\textwidth,trim={0 0 0 2.5cm},clip]{beverage_recommendations}
\end{minipage}
\end{figure}
