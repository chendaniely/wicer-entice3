...
\begin{center}
\Huge Days feeling sad, blue, or depressed in the last 30 days\\
\end{center}

<<depressed>>=
config_pt_depressed_30 <- 15
...
\end{figure}
\Large You\\
\Large \Sexpr{config_pt_depressed_30} days\\
...
\end{figure}
\Large Other \Sexpr{tolower(get_men_women(config_pt_sex))} in\\
\Large your age group\\
\Large \Sexpr{config_sex_age_depressed_30} days
\end{center}
\end{minipage}
\end{table}
